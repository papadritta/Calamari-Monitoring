...
sudo ufw allow 3000
```
**NOTE: This is additional rules for UFW. Don't forget to set all the rules and add Default port 22 for your SSH client to avoid loose the control of your server.**
